class WorkspaceView {
  constructor({ onProjectChange, onAction, onPromptChange, onTerminalInput, maxOutputChars, sidebar }) {
    ...
    this.element.innerHTML = this.sidebar ? `
      <header class="claude-workspace__header claude-workspace__sidebar-header">
        <div class="claude-workspace__brand">
          <span class="claude-workspace__logo">✦</span>
          <div class="claude-workspace__title">Claude</div>
        </div>
        <div class="claude-workspace__status" data-status="ready">
          <span class="claude-workspace__status-dot"></span>
          <span class="claude-workspace__status-label">Ready</span>
      ...
      <section class="claude-workspace__sidebar-controls">
        ...
        <div class="claude-workspace__session-controls">
          <select id="claude-workspace-sessions" class="claude-workspace__sessions"><option value="">New session</option></select>
